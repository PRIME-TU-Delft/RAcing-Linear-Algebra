...
export default function EndGameScreen() {
    ...
    useChain(
        [titleRef, subtitleRef, qrRef, msgRef, btnRef],
        [0, 0.25, 0.5, 0.75, 1],
        4000
    )
    ...
    return (
        <>
            <div className="end-game-container">
                <a.div style={titleAnimation} className="end-game-text">
                    We hope you enjoyed playing the game!
                </a.div>
                <a.div style={subtitleAnimation} className="end-game-subtext">
                    The following QR code takes you to a form with some
                    questions about your experience:
                </a.div>
                <a
                    href="https://docs.google.com/forms/d/e/1FAIpQLSeT8gtxKftwHNPz9lDo0rQD_tDpw-YJrPsiWAqKVHqArtGngg/viewform?usp=sf_link"
                    target="_blank"
