...
function TeamPreview(props: Props) {
    ...
    const [showMainTeam, setShowMainTeam] = useState<boolean>(true)
                            ...
                            <a.div style={style} key={i}>
                                <div className="team-container">
                                    <div className="team-image-container rounded-circle">
                                        {props.theme.toLocaleLowerCase() === "train" ? (<div>
                                            ...
                                            viewBox="0 0 505 500"
                                            style={{ fill: 'red', width: '100%', height: 'auto', top: '38%', left: '5%' }}
                                            >
                                        ...
                                        data-name="Layer 1" 
                                        viewBox="0 0 505 500"
                                        style={{ fill: '#fff', width: '100%', height: 'auto', top: '43%', left: '5%' }}
                                        >
                                        <path d="M0 14.67l44.44 9.77h181.78L186 0l-134.89 9.78L0 9.33v5.34z" />
                                        </svg>
                                    </div>}
                                         <img
                                                ...
                                                style={{
                                                    top: props.theme.toLocaleLowerCase() === "boat" ? "25%" : "0"
                                                }}
                                            />
                                    </div>
