...
function TeamPreview(props: Props) {
    ...
    const subtitleAnimation = useSpring({
        ...
        from: { opacity: 0 },
        to: { opacity: 1 },
        onRest: () => setTimeout(() => setStartCountdown(curr => true), 10000)
    })
    
    const teamTransitionRef = useSpringRef()
    const teamTransition = useTransition(props.ghostTeams, {
    ...
    useChain([titleAnimationRef, subtitleAnimationRef, teamTransitionRef], [0, 0.1, 0.2], 10000)
