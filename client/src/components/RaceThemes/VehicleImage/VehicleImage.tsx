...
function VehicleImage(props: Props) {
    ...
    const trainSvgOverlay = (
        <>
            <svg  
                className={"vehicle-main-svg-image " + sizingClass} xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 600 600"
            ...
            <svg  
                className={"vehicle-highlight-svg-image " + sizingClass} xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 600 600"
    ...
    const boatSvgOverlay = (
        <>
             <svg 
                className={"vehicle-main-svg-image "}     
                viewBox="0 0 474.67 148.89"
                style={{ fill: 'red', width: '100%', height: 'auto', top: '50%', left: '5%' }}
                >
                <path d="M0 42.67l4 90.22 43.11 16 170.22-15.11L474.67 0 202.67 38.22 46.22 51.11 0 42.67z" />
            </svg>
        </>
    )
    ...
    return(
        <>
            ...
            <img
                ...
                alt="vehicle"
                className={"background-vehicle-overlay-image " + sizingClass}
            />
        </>
    )
}
