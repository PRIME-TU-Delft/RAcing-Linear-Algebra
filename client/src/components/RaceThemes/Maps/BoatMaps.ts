...
import SmallShark from "./SpecialDecorationComponents/SmallShark/SmallShark"
import Cruise from "./SpecialDecorationComponents/Cruise/Cruise"
...
const mapOne = {
            ...
            components: [
                ...
                { component: Cruise, props: { startLeft: 4, startTop: 10, scale: 1.7} },
            ],
